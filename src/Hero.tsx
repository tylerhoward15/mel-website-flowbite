...
function CustomHero() {
  return (
    <div className="bg-gradient-to-r from-gray-500 to-gray-400 md:grid md:grid-cols-2 p-3 pb-0">
      <div className="z-0 text-2xl">
        <h1 className="text-[#f8f9fa]">Melody Hollis</h1>
      ...
      <div className="text-[#f8f9fa] row-start-2 text-4xl">
